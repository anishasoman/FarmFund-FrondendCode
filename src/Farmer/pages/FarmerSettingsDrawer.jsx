...
export default function FarmerSettingsDrawer({ openSettings, setOpenSettings }) {
    ...
    <Drawer open={openSettings} onClose={() => setOpenSettings(false)} position="right">
      ...
      <DrawerItems>
        <form onSubmit={handleSave} className="grid gap-4 p-2">
          ...
          <TextInput name="farmName" value={formData.farmName} onChange={handleChange} />

          <Label>Location</Label>
          <TextInput name="location" value={formData.location} onChange={handleChange} />

          <Label>About Farm</Label>
          <Textarea rows={3} name="aboutFarm" value={formData.aboutFarm} onChange={handleChange} />
