...
<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
  ...
  <div className="lg:col-span-2 order-2 lg:order-1">
    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
      ...
      <button
        ...
        className="w-full sm:w-auto border border-green-700 text-green-700 px-4 py-2 sm:py-1 rounded-lg text-sm hover:bg-green-50 dark:hover:bg-gray-800 transition"
      >
        Browse More
      </button>
    </div>
    ...
    <div className="flex flex-col sm:flex-row justify-center items-center gap-3 mt-6">
      <button
        ...
        className="w-full sm:w-auto px-4 py-2 sm:py-1 border rounded disabled:opacity-40 dark:border-gray-600 dark:text-white"
      >
        Prev
      </button>
  ...
  <div className="lg:col-span-1 order-1 lg:order-2">
    ...
    <div className="space-y-4 max-h-[400px] sm:max-h-[500px] lg:max-h-[600px] overflow-y-auto pr-1 sm:pr-2">
      {updates.length === 0 ? (
          ...
          <Card key={u.updateId} className="p-4 dark:bg-gray-800">
            <div className="flex items-start gap-3 mb-3">
              ...
              <div className="min-w-0">
                <p className="font-medium text-sm sm:text-base dark:text-white truncate">
                  {u.farmerName}
                </p>
                ...
                {u.media.map((m, idx) =>
                  m.type === "video" ? (
                    <video
                      ...
                      controls
                      className="rounded-lg h-32 sm:h-28 w-full object-cover"
                    >
                      <source src={`${m.url}`} />
                    </video>
                  ) : (
